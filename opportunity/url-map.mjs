export const URL_OPPORTUNITY_MAP = Object.freeze({
  ...
  '/duelo/he-perdido-a-mi-bebe-durante-el-embarazo/':{domain:'pregnancy_loss_grief',needs:['pregnancy_loss_grief','grief_support','professional_assessment'],intents:[],opportunities:['PSYCHOLOGY'],risk:'high',consent:'before_lead',commercialPolicy:'restricted',defaultFlags:['medical_boundary','no_causal_attribution','no_automatic_diagnosis','safety_override']},
  '/duelo/ha-muerto-por-suicidio-alguien-que-quiero/':{domain:'suicide_bereavement',needs:['suicide_bereavement','grief_support','professional_assessment'],intents:[],opportunities:['PSYCHOLOGY'],risk:'high',consent:'before_lead',commercialPolicy:'restricted',defaultFlags:['suicide_postvention','no_causal_attribution','no_automatic_diagnosis','no_method_details','official_resources_first','no_commercial_crisis_cta','safety_override']},
...
export const EXPECTED_PRODUCTION_URL_COUNT = 53;
