...
export const OPPORTUNITIES = Object.freeze({
  ...
  FAMILY_THERAPY:{category:'health',risk:'high',models:['booking','cpl'],partnerVerification:'required'},
  RELATIONSHIP_SUPPORT:{category:'relationships',risk:'medium',models:['booking','cpl'],partnerVerification:'required'},
  FAMILY_MEDIATION:{category:'legal_social',risk:'medium',models:['booking','cpl'],partnerVerification:'required'},
  SOCIAL_ACTIVITIES:{category:'social',risk:'low',models:['affiliate','cpl','booking']},
